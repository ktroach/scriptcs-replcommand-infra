...
namespace ScriptCs.Tests
{
    public class RuntimeServicesTests
    {
        public class TheCreateContainerMethod
        {
            ...
            [Fact]
            public void ShouldRegisterTheDefaultReplCommandServiceIfNoOverride()
            {
                _runtimeServices.Container.Resolve<IReplCommandService>().ShouldNotBeNull();
            }
            ...
            [Fact]
            public void ShouldRegisterTheOverriddenReplCommandService()
            {
                var mock = new Mock<IReplCommandService>();
                _overrides[typeof(IReplCommandService)] = mock.Object.GetType();
                _runtimeServices.Container.Resolve<IReplCommandService>().ShouldBeType(mock.Object.GetType());
            }
